...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/awxkit-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14353&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/awxkit-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `awxkit` can be installed with:

```
conda install awxkit
```

It is possible to list all of the versions of `awxkit` available on your platform with:
